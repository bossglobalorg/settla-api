...
export class BankAccountsService {
  ...
  private mapResponseToEntity(
    ...
    return {
      ...
      businessId: requestDto.business_id,
      personId: requestDto.person_id,
      userId: requestDto.userId,
      label: response.label,
      whitelistEnabled: requestDto.whitelist_enabled,
      whitelist: requestDto.whitelist,
      autosweepEnabled: requestDto.autosweep_enabled,
